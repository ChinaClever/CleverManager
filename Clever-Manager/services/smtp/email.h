...
#define  Email_Server 	"mail.qq.com"     //"smtp.qq.com" /*发件邮箱服务器：*/
#define  Email_UsrName   "test@qq.com"       //"pdu_email@foxmail.com"	/* 发送邮箱账号 */
#define  Email_Password   ""	//"luozhiyong131" /*发送邮箱密码：*/
