 ...
 * @return
 */
QCPBars *DrawChart::createBar(QString name)
{
 ...
 * @param labels
 */
void DrawChart::initXAxis(QVector<QString> &labels)
{
 ...
 * @param lab
 */
void DrawChart::setYLabel(QString lab)
{
 ...
 * @param range
 */
void DrawChart::setRange(int range)
{
    customPlot->yAxis->setRange(0, range);
}

void DrawChart::initLegend(void)
{
