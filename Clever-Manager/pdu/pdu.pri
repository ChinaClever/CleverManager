...
HEADERS += \
    ...
    $$PWD/data/statistics/pdupackettg.h \
    $$PWD/data/statistics/pdutgcom.h \
    $$PWD/data/statistics/pdudatatg.h \
    $$PWD/data/statistics/pdudatatgthread.h \
    $$PWD/dev/pdudevspied.h \
    $$PWD/data/hash/read/pduhashread.h \
    $$PWD/dev/devList/pdudevlist.h \
    $$PWD/dev/devList/pdudlobject.h \
    $$PWD/dev/devstore/pdudevlistread.h \
    $$PWD/dev/devstore/pdudevlistsave.h \
    $$PWD/dev/devstore/pdudlsavethread.h \
    $$PWD/dev/devGroup/pdudghash.h \
    $$PWD/dev/devGroup/pdudglist.h \
    $$PWD/dev/devType/pdudtname.h \
    $$PWD/dev/devstore/pdudevdel.h \
    $$PWD/dev/devmanage/pdudmmanage.h \
    ...
    $$PWD/dev/devstore/pdudevaddrthread.h \
    $$PWD/dev/devAlarm/pdu_alarmusic.h \
    $$PWD/dev/devAlarm/pdu_alarmmusicrun.h
...
SOURCES += \	
    ...
    $$PWD/data/statistics/pdupackettg.cpp \
    $$PWD/data/statistics/pdutgcom.cpp \
    $$PWD/data/statistics/pdudatatg.cpp \
    $$PWD/data/statistics/pdudatatgthread.cpp \
    $$PWD/dev/pdudevspied.cpp \
    $$PWD/data/hash/read/pduhashread.cpp \
    $$PWD/dev/devList/pdudevlist.cpp \
    $$PWD/dev/devList/pdudlobject.cpp \
    $$PWD/dev/devstore/pdudevlistread.cpp \
    $$PWD/dev/devstore/pdudevlistsave.cpp \
    $$PWD/dev/devstore/pdudlsavethread.cpp \
    $$PWD/dev/devGroup/pdudghash.cpp \
    $$PWD/dev/devGroup/pdudglist.cpp \
    $$PWD/dev/devType/pdudtname.cpp \
    $$PWD/dev/devstore/pdudevdel.cpp \
    $$PWD/dev/devmanage/pdudmmanage.cpp \
    ...
    $$PWD/dev/devstore/pdudevaddrthread.cpp \
    $$PWD/dev/devAlarm/pdu_alarmusic.cpp \
    $$PWD/dev/devAlarm/pdu_alarmmusicrun.cpp
